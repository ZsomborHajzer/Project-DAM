        ...
        <div class="b-content">
            <form class="t-content" method="post">
                ...
                <select id="s_talent" name="dataTalents" id="dataTalents">
                    ...
                    $stmtToGetSpecialites = $dbHandler->query("SELECT * FROM tblSpecialty");
            ...
            <div class="t-content">
                ...
                <div class="gen-content">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($_POST["dataNameOrEmail"] != "") {
                            ...
                            if (filter_input(INPUT_POST, "dataNameOrEmail", FILTER_VALIDATE_EMAIL)) {
                                ...
                                $stmt = $dbHandler->prepare("SELECT * FROM tblUser INNER JOIN tblSpecialty ON fiSpecialty  = tblSpecialty.idSpecialty WHERE dtEmail  LIkE ?  AND  dtIsAdmin = 0");
                    ...
                    ?>
                                ...
                                $stmt = $dbHandler->prepare("SELECT * FROM tblUser INNER JOIN tblSpecialty ON fiSpecialty  = tblSpecialty.idSpecialty  WHERE dtFirstName  LIkE ?  AND  dtIsAdmin = 0");
                                ...
                                while ($row = $stmt->fetch()) {
                                    ...
                                    echo "<div class= 'mClass'>";
                                    echo "<img class='g-img' src=" . $row['dtImage'] . ">";
                                    echo "<p class='g-p'> <a href='public.php?id="  . $row['idUser'] . "'>" . $row['dtFirstName'] . " " . $row['dtLastName'] . "</a></p>";
                                    echo "<p class='g-email'>" . $row['dtEmail'] . "</p>";
                                    echo "<p class='g-descr'>" . $row['dtDescription'] . "</p>";
                                    echo "<p class='g-price'>" . $row['dtPrice'] . "€</p>";
                                    echo "<form>";
                            ...
                            if ($sanitzeOption == "Active") {
                                ...
                                $stmt = $dbHandler->prepare("SELECT * FROM tblUser INNER JOIN tblSpecialty ON fiSpecialty = tblSpecialty.idSpecialty  WHERE dtActive = 1  AND  dtIsAdmin = 0 ORDER BY dtFirstName ASC ");
                                ...
                                $stmt = $dbHandler->prepare("SELECT * FROM tblUser INNER JOIN tblSpecialty ON fiSpecialty = tblSpecialty.idSpecialty WHERE dtIsAdmin = 0 ORDER BY dtPrice  ASC");
                                ...
                                $stmt = $dbHandler->prepare("SELECT * FROM tblUser INNER JOIN tblSpecialty ON fiSpecialty = tblSpecialty.idSpecialty WHERE dtIsAdmin = 0 AND tblSpecialty.dtDescription = ? ORDER BY dtPrice ASC;");
