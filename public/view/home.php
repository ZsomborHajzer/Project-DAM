...
<body>
    <div id="mainBody">
        ...
        <div id="pictures">
            <img src="../img/wedding.jpg" alt="Add alt text">
            <img src="../img/event3.jpg" alt="Add alt text">
            <img src="../img/event1.jpg" alt="Add alt text">
        </div>
        <div id="leftText">
        ...
        <div id="rightPicture">
            <img src="../img/events.png" alt="Add alt text">
        </div>
        <div id="graph">
