...
<body>
    <div id="mainBody">
        ...
        <div id="pictures">
            <img src="images/homePageImg/wedding.jpg" alt="Add alt text">
            <img src="images/homePageImg/event3.jpg" alt="Add alt text">
            <img src="images/homePageImg/event1.jpg" alt="Add alt text">
        </div>
        <div id="leftText">
        ...
        <div id="rightPicture">
            <img src="images/homePageImg/events.png" alt="Add alt text">
        </div>
        <div id="graph">
            <p>idk a cute graphic maybe</p>
        </div>
        <div id="rightText">
